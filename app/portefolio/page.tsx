          ...
          <div className="flex flex-wrap gap-3 mb-8">
            {filters.map((filter) => (
              <button
                ...
                className={`px-3 py-1 rounded-full border text-sm transition-colors ${activeFilter === filter.id
                ...
                <Link key={p.id} href={`/portefolio/${p.id}`} className="">
                  ...
                  >
                    ...
                    <div className="grid sm:grid-cols-2 gap-3 mb-2">
                      <div>
                        <p className="my-2 font-semibold">ANTES</p>
                      ...
                      <div>
                        <p className="my-2 font-semibold">DEPOIS</p>
                        <div className="relative w-full h-40 sm:h-52 lg:h-60 overflow-hidden rounded">
                          <Image
                            src={p.imgDepoisSrc}
                            alt={`${p.title} depois`}
