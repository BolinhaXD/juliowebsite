...
export default function ProjectDetails() {
  const productId = useParams().projectId;
  const project = antesDepoisImages.find((p) => String(p.id) === productId);
  ...
  return (
    <div className="flex min-h-screen flex-col font-sans bg-[var(--platinum-50)] dark:bg-[var(--platinum-50)] text-zinc-900 dark:text-zinc-50">
      ...
      {/* Same section style as portefolio / about */}
      ...
      {/* Sobre este projeto – same pillar style as Sobre on home */}
